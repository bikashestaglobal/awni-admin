...
function TopNavigation() {
  ...
  // useEffect(() => {
  //   fetch(Config.SERVER_URL + "/awni-admin/searchSession?_id=" + localStorage.getItem("branchSession"), {
  //     method: "GET",
  //     headers: {
      ...
      {state && (
        <nav className="navbar top-navbar navbar-expand-md navbar-light">
          ...
          <div className="navbar-header">
            <Link className="navbar-brand" to="/awni-admin">
              {/* <!-- Logo icon --> */}
              <b>
                {/* <!-- Dark Logo icon --> */}
                <img
