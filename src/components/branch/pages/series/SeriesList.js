...
const SeriesList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/series/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    ...
    fetch(
      `${Config.SERVER_URL}/series?skip=${pagination.skip}&limit=${
        pagination.limit
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/series?skip=0&limit=50000&query=${
        queryText || "null"
      }&status=All`,
      {
        method: "GET",
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles mb-0">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Series</h3>
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/series/add",
                    }}
                  >
                    <span className={"fas fa-plus"}></span> Series
                  </Link>

                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/series/addFromCSV",
                    }}
                  >
                  ...
                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/series/editFromCSV",
                    }}
                  >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/series/edit/${data.id}`,
                                    }}
                                  >
                                    <span
