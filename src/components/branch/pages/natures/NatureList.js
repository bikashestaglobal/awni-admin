...
const NatureList = (props) => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${Config.SERVER_URL}/natures?skip=${pagination.skip}&limit=${
        pagination.limit
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/natures?skip=0&limit=50000&query=${
        queryText || "null"
      }&status=All`,
      {
        method: "GET",
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles mb-0">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Natures</h3>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/awni-admin">Admin</Link>
              </li>
              <li className="breadcrumb-item active">Nature List</li>
            </ol>
          </div>
        </div>
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/nature/add",
                    }}
                  >
                    <span className={"fas fa-plus"}></span> Nature
                  </Link>

                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/nature/addFromCSV",
                    }}
                  >
                  ...
                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/nature/editFromCSV",
                    }}
                  >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/nature/edit/${data.id}`,
                                    }}
                                  >
                                    <span
