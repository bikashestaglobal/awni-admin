...
function ParCategoryList(props) {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/parentCategories/${deleteId}`, {
      method: "DELETE",
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/parentCategory/add",
                    }}
                  >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/parentCategory/edit/${record.id}`,
                                    }}
                                  >
                                    <span
...
export default ParCategoryList;
