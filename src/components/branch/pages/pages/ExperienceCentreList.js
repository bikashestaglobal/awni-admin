...
//  Component Function
function ExperienceCentreList(props) {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/experienceCentres/${deleteId}`, {
      method: "DELETE",
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles mb-0">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Experience Centre</h3>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/awni-admin">Admin</Link>
              </li>
              <li className="breadcrumb-item active">Centre List</li>
            </ol>
          </div>
        </div>
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/experienceCentre/add",
                    }}
                  >
                    <span className={"fas fa-plus"}></span> Centre
                  </Link>
                </div>
              </div>
            </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/experienceCentre/edit/${record.id}`,
                                    }}
                                  >
                                    <span
...
export default ExperienceCentreList;
