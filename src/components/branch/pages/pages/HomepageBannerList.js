...
//  Component Function
function HomepageBannerList(props) {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/homepageBanners/${deleteId}`, {
      method: "DELETE",
  ...
  // Count Records
  useEffect(() => {
    fetch(`${Config.SERVER_URL}/homepageBanners?skip=0&limit=5000`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/banner/add",
                    }}
                  >
                    <span className={"fas fa-plus"}></span> Add Banner
                  </Link>
                </div>
              </div>
            </div>
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/banner/edit/${record.id}`,
                                    }}
                                  >
                                    <span
