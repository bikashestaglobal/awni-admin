...
const PatternList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/patterns/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    ...
    fetch(
      `${Config.SERVER_URL}/patterns?skip=${pagination.skip}&limit=${
        pagination.limit
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/patterns?skip=0&limit=50000&query=${
        queryText || "null"
      }&status=All`,
      {
        method: "GET",
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles mb-0">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Patterns</h3>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/awni-admin">Admin</Link>
              </li>
              <li className="breadcrumb-item active">Pattern List</li>
            </ol>
          </div>
        </div>
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/pattern/add",
                    }}
                  >
                    <span className={"fas fa-plus"}></span> Pattern
                  </Link>

                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/pattern/addFromCSV",
                    }}
                  >
                  ...
                  <Link
                    className="btn btn-info float-right rounded mr-2"
                    to={{
                      pathname: "/awni-admin/pattern/editFromCSV",
                    }}
                  >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/pattern/edit/${data.id}`,
                                    }}
                                  >
                                    <span
