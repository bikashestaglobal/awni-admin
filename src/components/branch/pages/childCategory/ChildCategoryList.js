...
function ChildCategoryList(props) {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/childCategories/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/childCategories?skip=${pagination.skip}&limit=${pagination.limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
      ...
      .then(
        (result) => {
          ...
          if (result.status === 200) {
            console.log("child, cat", result.body);
  ...
  // Count Records
  useEffect(() => {
    fetch(`${Config.SERVER_URL}/childCategories?skip=0&limit=5000`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/childCategory/add",
                    }}
                  >
                          ...
                          {allRecords.map(function (record, index) {
                            return (
                              <tr key={index}>
                                ...
                                {/* <td>{record.status ? "active" : "disabled"}</td> */}
                                <td>
                                  {date.format(
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/childCategory/edit/${record.id}`,
                                    }}
                                  >
                                    <span
