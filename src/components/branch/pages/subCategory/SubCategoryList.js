...
function SubCategoryList(props) {
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/categories?skip=${pagination.skip}&limit=${pagination.limit}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  // Count Records
  useEffect(() => {
    fetch(`${Config.SERVER_URL}/categories?skip=0&limit=500000`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_branch_token")}`,
              ...
              <div className={"card-body pb-0 pt-2"}>
                <div>
                  ...
                  <Link
                    ...
                    to={{
                      pathname: "/awni-admin/subCategory/add",
                    }}
                  >
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  {record.catalogue != "null" ? (
                                    <a
                                      ...
                                      target="_blank"
                                      href={record.catalogue}
                                    >
                                      <span className="fa fa-eye text-light"></span>
                                    </a>
                                  ) : (
                                    "N/A"
                                  )}
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/subCategory/edit/${record.id}`,
                                    }}
                                  >
                                    <span
