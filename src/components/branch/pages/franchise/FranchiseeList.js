...
function FranchiseeList(props) {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/franchisee/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    ...
    fetch(
      `${Config.SERVER_URL}/franchisee?skip=${pagination.skip}&limit=${
        pagination.limit
      }&query=${queryText || "null"}&start_date=${
        startDate || "null"
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/franchisee?skip=0&limit=50000&query=${
        queryText || "null"
      ...
      <div className={"container-fluid"}>
        ...
        <div className="row page-titles mb-0">
          <div className="col-md-5 col-8 align-self-center">
            <h3 className="text-themecolor m-b-0 m-t-0">Franchisee Enquiry</h3>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/awni-admin">Admin</Link>
              </li>
              <li className="breadcrumb-item active">Franchisee List</li>
            </ol>
          </div>
        </div>
                          ...
                          {allRecords.map(function (record, index) {
                            return (
                              <tr key={index}>
                                ...
                                <td>{record.interested_city}</td>
                                <td>{record.work_profile}</td>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/franchisee/edit/${record.id}`,
                                    }}
                                  >
                                    <span
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/awni-admin/franchisee/view/${record.id}`,
                                    }}
                                  >
                                    <span
